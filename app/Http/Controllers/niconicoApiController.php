...
class niconicoApiController extends Controller
{
    ...
    public function index(Request $request) {
        try {
            ...
            // 検索から排除する条件
            $eliminationCriteria = urlencode(' -StepMania -歌ってみた -演奏して見た -演奏してみた -PVつけてみた -初音ミク-ProjectDIVA- -遊戯王 -喋らせてみた -ボカロカラオケDB -MMD -MMD杯 -mikumikudance -クロスフェード -日刊VOCALOIDランキング -VOCALOIDランキング -作業用BGM -クロスフェードデモ -ボカロラオケDB -VOCALOIDにインタビューシリーズ -VOCALOIDカバー曲 -VOCALOIDアレンジ曲 -VOCALOID-CDデモ -DIVAエディット動画');
            // 選択されたVOCALとジャンルを整形
